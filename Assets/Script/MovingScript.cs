...
public class MovingScript : MonoBehaviour {
    ...
    void OnCollisionEnter(Collision col)
    {
      ...
      {
            //this.transform.GetChild(12).GetComponent<ParticleSystem>().enableEmission = enabled;
            //this.transform.GetComponent<Vatra>().Play();
            ...
            //transform.RigidbodyConstraints.FreezePositionX = false;
    ...
    IEnumerator ExecuteAfterTime(float time)
    {
        ...
        // Debug.Log(transform.position);// = respawnPoint.position;
